  ...
  const ideaTours: ProductTourConfig[] = [
    ...
    },
    {
      ...
      steps: [
        {
          id: "open-scheduled",
          title: map["tour.setIcsSources.step1.title"],
          content: map["tour.setIcsSources.step1.content"],
          target: "[data-tour='scheduled-tab']",
          placement: "bottom",
          hideFooterButton: true,
          waitForElement: true,
        ...
        {
          id: "scheduled-more-button",
          title: map["tour.setIcsSources.step2.title"],
          content: map["tour.setIcsSources.step2.content"],
          target: "[data-tour='scheduled-more-button']",
          placement: "bottom",
          hideFooterButton: true,
          waitForElement: true,
        ...
        {
          id: "open-ics-source-management",
          title: map["tour.setIcsSources.step3.title"],
          content: map["tour.setIcsSources.step3.content"],
          target: "[data-tour='open-ics-source-management-button']",
          placement: "bottom",
          hideFooterButton: true,
          waitForElement: true,
          spotlightPadding: 8,
        ...
        {
          id: "add-ics-source",
          title: map["tour.setIcsSources.step4.title"],
          content: map["tour.setIcsSources.step4.content"],
          target: "[data-tour='add-ics-source-buttons']",
          placement: "bottom",
          hideFooterButton: true,
          waitForElement: true,
          spotlightPadding: 8,
        ...
        {
          id: "select-a-color",
          title: map["tour.setIcsSources.step5.title"],
          content: map["tour.setIcsSources.step5.content"],
          target: "[data-tour='select-a-color']",
          placement: "bottom",
          hideFooterButton: true,
          waitForElement: true,
          spotlightPadding: 8,
        ...
        {
          id: "input-src-name",
          title: map["tour.setIcsSources.step6.title"],
          content: map["tour.setIcsSources.step6.content"],
          target: "[data-tour='input-src-name']",
          placement: "bottom",
          hideFooterButton: false,
          waitForElement: true,
          spotlightPadding: 8,
        ...
        {
          id: "input-src-url",
          title: map["tour.setIcsSources.step7.title"],
          content: map["tour.setIcsSources.step7.content"],
          target: "[data-tour='input-src-url']",
          placement: "bottom",
          hideFooterButton: false,
          waitForElement: true,
          spotlightPadding: 8,
        ...
        {
          id: "save-ics-source",
          title: map["tour.setIcsSources.step8.title"],
          content: map["tour.setIcsSources.step8.content"],
          target: "[data-tour='save-ics-source-button']",
          placement: "bottom",
          hideFooterButton: false,
          waitForElement: true,
          spotlightPadding: 8,
