...
所以，他不必花俏，只需要一些設定與重要的頁面即可。
他的介面很簡樸，只分成上中下三個區塊，上面就是一些 settings，中間則像您使用的瀏覽器的Tabs一樣，但是是固定的頁面讓您切換，下面就是該頁面的內容。
[圖，NBL的介面圖]

原則上，當您第一次打開這個App時，可能會覺得不曉得從何開始，這很正常，就像是下面的狀態機的圖那般，雖然我們生活中確實在許多狀態間切換，但是，我們還沒有把他們宣告給NBL，所以，當我們打開NBL的時候，只會看到每個頁面都空蕩蕩的。
[圖，狀態機圖](States.png)

TODO 所以，一開始， idea -> tasks
